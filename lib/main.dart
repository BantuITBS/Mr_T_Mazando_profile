...
class _CVHomePageState extends State<CVHomePage>
      ...
      child: Container(
        ...
        child: ListView(
          ...
          children: <Widget>[
            ...
            _buildDrawerItem(
                Icons.home, 'Welcome', 'welcome', _lightColor, Colors.red),
            _buildDrawerItem(Icons.person, 'Professional Summary', 'summary',
                _lightColor, Colors.orange),
            _buildDrawerItem(Icons.build, 'Technical Skills', 'skills',
                _lightColor, Colors.yellow[700]!),
            _buildDrawerItem(Icons.people, 'Soft Skills', 'soft_skills',
                _lightColor, Colors.green),
            _buildDrawerItem(Icons.work, 'Professional Experience',
                'experience', _lightColor, Colors.blue),
            _buildDrawerItem(Icons.school, 'Education', 'education',
                _lightColor, Colors.indigo),
            _buildDrawerItem(Icons.card_membership, 'Certifications',
                'certifications', _lightColor, Colors.purple),
            _buildDrawerItem(Icons.emoji_events, 'Accomplishments',
                'accomplishments', _lightColor, Colors.pink),
            _buildDrawerItem(Icons.people_outline, 'References', 'references',
                _lightColor, Colors.teal),
            _buildDrawerItem(
                Icons.folder, 'Projects', 'projects', _lightColor, Colors.cyan),
            _buildDrawerItem(Icons.description, 'Full CV', 'full_cv',
                _lightColor, _secondaryColor),
          ],
        ),
      ),
    );
              ...
              Container(
                ...
                child: ListView(
                  children: [
                    ...
                    _buildSidebarItem(
                        Icons.home, 'Welcome', 'welcome', Colors.red),
                    _buildSidebarItem(Icons.person, 'Professional Summary',
                        'summary', Colors.orange),
                    _buildSidebarItem(Icons.build, 'Technical Skills', 'skills',
                        Colors.yellow[700]!),
                    _buildSidebarItem(Icons.people, 'Soft Skills',
                        'soft_skills', Colors.green),
                    _buildSidebarItem(Icons.work, 'Professional Experience',
                        'experience', Colors.blue),
                    _buildSidebarItem(
                        Icons.school, 'Education', 'education', Colors.indigo),
                    _buildSidebarItem(Icons.card_membership, 'Certifications',
                        'certifications', Colors.purple),
                    _buildSidebarItem(Icons.emoji_events, 'Accomplishments',
                        'accomplishments', Colors.pink),
                    _buildSidebarItem(Icons.people_outline, 'References',
                        'references', Colors.teal),
                    _buildSidebarItem(
                        Icons.folder, 'Projects', 'projects', Colors.cyan),
                    _buildSidebarItem(Icons.description, 'Full CV', 'full_cv',
                        _secondaryColor),
                  ],
                ),
              ),
  ...
  Widget _buildDrawerItem(IconData icon, String title, String section,
    ...
    return Container(
      ...
      child: ListTile(
        leading: Icon(icon,
            color: _currentSection == section ? _secondaryColor : iconColor),
        title: Text(
          title,
          style: TextStyle(
            color:
                _currentSection == section ? _secondaryColor : Colors.grey[700],
            fontWeight: _currentSection == section
                ? FontWeight.bold
                : FontWeight.normal,
          ),
        ),
  ...
  Widget _buildSidebarItem(
      IconData icon, String title, String section, Color iconColor) {
    return Container(
      margin: const EdgeInsets.symmetric(horizontal: 8, vertical: 4),
      decoration: BoxDecoration(
        color: _currentSection == section
    ...
    switch (section) {
      ...
      case 'skills':
        return SectionHeader(
          ...
          primaryColor: _primaryColor,
          secondaryColor: _secondaryColor,
          child: TechnicalSkillsContent(
              primaryColor: _primaryColor, secondaryColor: _secondaryColor),
        );
      case 'soft_skills':
        return SectionHeader(
          icon: Icons.people,
      ...
      case 'experience':
        return SectionHeader(
          ...
          primaryColor: _primaryColor,
          secondaryColor: _secondaryColor,
          child: ProfessionalExperienceContent(
              primaryColor: _primaryColor, secondaryColor: _secondaryColor),
        );
      case 'education':
        return SectionHeader(
      ...
      case 'certifications':
        return SectionHeader(
          ...
          child: CertificationsContent(
              primaryColor: _primaryColor, launchURL: _launchURL),
        );
        ...
        PopupMenuButton(
          ...
          itemBuilder: (context) => [
            ...
            _buildContactMenuItem(
              ...
              onTap: () => launchURL(
                  'https://www.linkedin.com/in/takawira-mazando-3a775715b'),
            ),
            _buildContactMenuItem(
              context,
    ...
    return Column(
      ...
      children: [
        ExperienceCard(
          ...
          responsibilities: [
            _buildResponsibilityItem(FontAwesomeIcons.users,
            ...
            _buildResponsibilityItem(FontAwesomeIcons.tachometerAlt,
            ...
            _buildResponsibilityItem(FontAwesomeIcons.lightbulb,
            ...
            _buildResponsibilityItem(FontAwesomeIcons.projectDiagram,
                "Applied custom models and algorithms to data sets to evaluate and solve diverse company problems."),
            _buildResponsibilityItem(FontAwesomeIcons.filter,
            ...
            _buildResponsibilityItem(FontAwesomeIcons.graduationCap,
                "Facilitated and executed strategies to educate customers on data analysis and interpretation."),
            _buildResponsibilityItem(FontAwesomeIcons.database,
            ...
            _buildResponsibilityItem(FontAwesomeIcons.desktop,
            ...
            _buildResponsibilityItem(FontAwesomeIcons.chartPie,
            ...
            _buildResponsibilityItem(FontAwesomeIcons.eye,
            ...
            _buildResponsibilityItem(FontAwesomeIcons.handsHelping,
                "Mentored and led junior analytics team members, fostering growth in data modeling and BI tools."),
            _buildResponsibilityItem(FontAwesomeIcons.chalkboardTeacher,
            ...
            _buildResponsibilityItem(FontAwesomeIcons.robot,
                "Automated workflows with Power Automate, Power Apps, and Python (Pandas, NumPy, openpyxl), integrating Supabase, SAP, and Hadoop."),
            _buildResponsibilityItem(FontAwesomeIcons.shieldAlt,
                "Applied CAATs and auditing methodologies for GDPR/POPIA compliance."),
            _buildResponsibilityItem(FontAwesomeIcons.globe,
                "Engaged in global seminars on Data Analytics and Business Intelligence."),
          ],
          projects: [
            LinkProject("Transnet Engineering Inventory Optimisation (2022)",
                "https://link-to-project1.com"),
            LinkProject(
                "Security of Supply – Department of Correctional Services (2024)",
                "https://link-to-project2.com"),
            LinkProject(
                "Lease Review – Carlton Centre, Transnet Properties (2023)",
                "https://link-to-project3.com"),
            LinkProject("KwaZulu-Natal Floods Disaster Management (2023)",
                "https://link-to-project4.com"),
          ],
        ...
        ExperienceCard(
          ...
          responsibilities: [
            ...
            _buildResponsibilityItem(FontAwesomeIcons.userShield,
                "Utilized Django's built-in authentication and authorization system for secure user management."),
            _buildResponsibilityItem(FontAwesomeIcons.box,
            ...
            _buildResponsibilityItem(FontAwesomeIcons.fire,
        ...
        ExperienceCard(
          ...
          responsibilities: [
            _buildResponsibilityItem(FontAwesomeIcons.database,
                "Extracted, cleaned, and consolidated operational data from ERP systems, maintenance logs, SCADA systems, and equipment sensors for dragliners and other mining machinery."),
            _buildResponsibilityItem(FontAwesomeIcons.brain,
                "Developed predictive maintenance models using ML and statistical methods to forecast equipment failures and reduce unplanned downtime."),
            _buildResponsibilityItem(FontAwesomeIcons.chartBar,
                "Monitored equipment KPIs including utilization, cycle times, and repair turnaround, identifying bottlenecks and operational inefficiencies."),
            _buildResponsibilityItem(FontAwesomeIcons.tools,
                "Analyzed historical shutdowns and maintenance schedules to optimize resource allocation and minimize operational downtime."),
            _buildResponsibilityItem(FontAwesomeIcons.table,
                "Built dashboards in Power BI and Tableau for real-time monitoring of equipment health, maintenance status, and project progress."),
            _buildResponsibilityItem(FontAwesomeIcons.wallet,
                "Evaluated maintenance costs, spare parts usage, and contractor performance to identify opportunities for cost optimization."),
            _buildResponsibilityItem(FontAwesomeIcons.users,
                "Collaborated with engineering, maintenance, and project teams to translate data insights into actionable recommendations for operational improvements."),
            _buildResponsibilityItem(FontAwesomeIcons.shieldAlt,
                "Monitored safety and compliance metrics, supporting risk mitigation and ensuring adherence to regulatory standards."),
            _buildResponsibilityItem(FontAwesomeIcons.search,
                "Performed exploratory data analysis (EDA) on sensor and operational data to identify trends, anomalies, and potential equipment issues."),
            _buildResponsibilityItem(FontAwesomeIcons.chalkboardTeacher,
                "Presented analytical findings to stakeholders through reports, dashboards, and data-driven storytelling to support decision-making."),
            _buildResponsibilityItem(FontAwesomeIcons.rocket,
                "Stayed current with industry trends, advanced analytics, and emerging AI/ML technologies to enhance mining operations and predictive capabilities."),
          ],
          primaryColor: primaryColor,
          secondaryColor: secondaryColor,
        ),
        ExperienceCard(
          ...
          responsibilities: [
            ...
            _buildResponsibilityItem(FontAwesomeIcons.clipboardCheck,
            ...
            _buildResponsibilityItem(FontAwesomeIcons.award,
            ...
            _buildResponsibilityItem(FontAwesomeIcons.microscope,
            ...
            _buildResponsibilityItem(FontAwesomeIcons.checkDouble,
            ...
            _buildResponsibilityItem(FontAwesomeIcons.chartBar,
                "Designed and developed interactive Power BI dashboards to visualize laboratory results, enabling real-time monitoring of dairy product safety and quality trends."),
          ],
          primaryColor: primaryColor,
          secondaryColor: secondaryColor,
        ),
    ...
    return Column(
      ...
      children: [
        ...
        EducationTile(
          ...
          period: "1997 – 1998",
          details:
              "Completed A-Level exams under the Cambridge International Examination system, demonstrating advanced proficiency in core science subjects.\n\nSubjects included: Mathematics, Chemistry, Biology",
          primaryColor: primaryColor,
        ...
        children: [
          ...
          SectionHeader(
            ...
            child: Container(
              padding: const EdgeInsets.all(16),
              child: CertificationsContent(
                  primaryColor: primaryColor, launchURL: launchURL),
            ),
          ),
          SectionHeader(
            icon: Icons.emoji_events,
        ...
        return Wrap(
          ...
          children: [
            SkillItem(
              icon: Icons.group,
              text:
                  "Team Leadership: Guided cross-functional teams of developers, analysts, and scientists to achieve project goals, fostering collaboration and innovation.",
              width: isMobile ? double.infinity : 300,
            ),
            SkillItem(
              icon: Icons.assignment,
              text:
                  "Project Management: Oversaw end-to-end delivery of complex technical projects, ensuring timely completion within budget and scope.",
              width: isMobile ? double.infinity : 300,
            ),
            SkillItem(
              icon: Icons.timeline,
              text:
                  "Strategic Planning: Aligned technical solutions with business objectives, driving organizational success in data-driven initiatives.",
              width: isMobile ? double.infinity : 300,
            ),
            SkillItem(
              icon: Icons.handshake,
              text:
                  "Stakeholder Engagement: Communicated effectively with clients, executives, and cross-industry partners to align on project goals and deliverables.",
              width: isMobile ? double.infinity : 300,
            ),
            SkillItem(
              icon: Icons.lightbulb,
              text:
                  "Problem-Solving: Developed innovative solutions to complex technical and analytical challenges in development and scientific contexts.",
              width: isMobile ? double.infinity : 300,
            ),
            SkillItem(
              icon: Icons.comment,
              text:
                  "Communication: Delivered clear, concise presentations and technical reports to diverse audiences, including students and industry stakeholders.",
              width: isMobile ? double.infinity : 300,
            ),
            SkillItem(
              icon: Icons.school,
              text:
                  "Mentoring and Lecturing: Mentored junior developers and analysts, and lectured on data science and microbiology, fostering professional and academic growth.",
              width: isMobile ? double.infinity : 300,
            ),
            SkillItem(
              icon: Icons.cached,
              text:
                  "Adaptability: Thrived in fast-paced, dynamic environments, adapting to new technologies and scientific methodologies.",
              width: isMobile ? double.infinity : 300,
            ),
            SkillItem(
              icon: Icons.access_time,
              text:
                  "Time Management: Prioritized tasks and managed deadlines effectively across development, analytics, and laboratory projects.",
              width: isMobile ? double.infinity : 300,
            ),
            SkillItem(
              icon: Icons.mediation,
              text:
                  "Conflict Resolution: Mediated team disputes to ensure cohesive collaboration and maintain project momentum.",
              width: isMobile ? double.infinity : 300,
            ),
            SkillItem(
              icon: Icons.gavel,
              text:
                  "Decision-Making: Made data-driven decisions to optimize outcomes in software development, data analysis, and laboratory operations.",
              width: isMobile ? double.infinity : 300,
            ),
            SkillItem(
              icon: Icons.people_alt,
              text:
                  "Collaboration: Built strong interdisciplinary partnerships with developers, scientists, and business teams to drive project success.",
              width: isMobile ? double.infinity : 300,
            ),
            SkillItem(
              icon: Icons.psychology,
              text:
                  "Emotional Intelligence: Leveraged empathy and interpersonal awareness to build trust and rapport in professional and academic settings.",
              width: isMobile ? double.infinity : 300,
            ),
          ],
        );
            ...
            if (projects != null && projects!.isNotEmpty) ...[
              ...
              Text("Key Projects:",
                  style: Theme.of(context)
                      ...
                      ?.copyWith(fontWeight: FontWeight.bold)),
              const SizedBox(height: 6),
              BulletList(projects!.map((p) => "${p.name}: ${p.url}").toList(),
                  primaryColor: primaryColor),
            ],
          ],
        ),
